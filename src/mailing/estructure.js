class mailStructure {
  ...
  setHtmlRegister(userName, password) {
    ...
    <div>
          ...
          <div>
            ...
            <a href="https://musicommerce2022.vercel.app/">Go to MusiCommerce</a>
    </div>`;
  }
  ...
  setResetPassword(email, token) {
    ...
    <div>
      ...
      <p>https://musicommerce2022.vercel.app/user/resetpassword</p>
    </div>
    `;
  }
  ...
  setResetPasswordAdmin(email) {
    ...
    <h3 style="color:#2B4570" >You have requested a password change from your email ${email}</h3>
    <h3>Click on the following link:</h3>
    <p>https://musicommerce2022.vercel.app/admin/resetpassword</p>
  </div>
  `;
  }
}
